(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookCardComponent = /** @class */ (function () {
                ...
                //format author name
                BookCardComponent.prototype.getName = function (authorName) {
                    var firstName = "";
                    var lastName = "";
                ...
                //open link to book 
                BookCardComponent.prototype.openBook = function () {
                    var key;
            ...
            var BookListComponent = /** @class */ (function () {
                function BookListComponent(bookService, route) {
                    ...
                    this.route.params.subscribe(function (params) {
                        _this.genre = params.genre;
                        _this.bookUrl = _this.baseUrl + ("topic=" + _this.genre) + "&mime_type=image%2f"; //get genre and modify bookUrl
                    });
                }
                BookListComponent.prototype.onScroll = function ($event) {
                ...
                BookListComponent.prototype.fetchBooks = function () {
                    var _this = this;
                    this.bookService.getBooks(this.bookUrl).subscribe(function (result) {
                        _this.result = result;
                        _this.books = _this.books.concat(result.results);
                    });
                };
                //filter books on input search
                BookListComponent.prototype.filterBooks = function () {
                    if (this.searchQuery != "") {
                        ...
                        var timeout = setTimeout(function () {
                            if (self.prevSearch != self.searchQuery) { //if prev input search same as next do not call api
                                ...
                                var encodedSearchTerm = encodeURIComponent(self.searchQuery); //encode search term
                ...
                BookListComponent.prototype.clearInput = function () {
                    this.searchQuery = "";
                    this.prevSearch = "";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookServiceService = /** @class */ (function () {
                ...
                BookServiceService.prototype.getBooks = function (bookUrl) {
